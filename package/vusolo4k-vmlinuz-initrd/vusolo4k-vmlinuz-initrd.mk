...
$(ARCHIVE)/$(VUSOLO4K_VMLINUZ_INITRD_SOURCE):
	$(DOWNLOAD) $(VUSOLO4K_VMLINUZ_INITRD_URL)/$(VUSOLO4K_VMLINUZ_INITRD_SOURCE)

$(D)/vusolo4k-vmlinuz-initrd: bootstrap $(ARCHIVE)/$(VUSOLO4K_VMLINUZ_INITRD_SOURCE)
	$(START_BUILD)
	tar -xf $(ARCHIVE)/$(VUSOLO4K_VMLINUZ_INITRD_SOURCE) -C $(BUILD_DIR)
	$(TOUCH)
