...
$(ARCHIVE)/$(VUUNO4K_VMLINUZ_INITRD_SOURCE):
	$(DOWNLOAD) $(VUUNO4K_VMLINUZ_INITRD_URL)/$(VUUNO4K_VMLINUZ_INITRD_SOURCE)

$(D)/vuuno4k-vmlinuz-initrd: bootstrap $(ARCHIVE)/$(VUUNO4K_VMLINUZ_INITRD_SOURCE)
	$(START_BUILD)
	tar -xf $(ARCHIVE)/$(VUUNO4K_VMLINUZ_INITRD_SOURCE) -C $(BUILD_DIR)
	$(TOUCH)
